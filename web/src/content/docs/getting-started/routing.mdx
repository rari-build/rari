...
```tsx title="src/app/users/[id]/layout.tsx"
import type { LayoutProps } from 'rari'
...
```tsx title="src/app/dashboard/loading.tsx"
...
```tsx title="src/app/dashboard/error.tsx"
'use client'
...
```typescript title="src/app/api/users/[id]/route.ts"
import type { RouteHandler } from 'rari'
