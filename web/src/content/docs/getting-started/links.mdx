...
```tsx title="src/app/components/Navigation.tsx"
...
```tsx title="src/app/components/SearchForm.tsx"
'use client'
...
```tsx title="src/app/components/LogoutButton.tsx"
'use client'
...
import { usePathname, useSearchParams } from 'rari/router'
