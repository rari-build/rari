...
export default function HeroSection() {
  ...
  return (
    <div className="relative overflow-hidden w-full min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-blue-900/6 via-transparent to-transparent"></div>
      <div className="absolute inset-0 bg-linear-to-br from-blue-500/4 via-cyan-500/3 to-[#fd7e14]/3"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-8 group">
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-br from-[#fd7e14] to-[#e8590c] rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
              <div className="relative w-20 h-20 lg:w-24 lg:h-24 bg-linearto-br from-[#fd7e14] to-[#e8590c] rounded-2xl flex items-center justify-center shadow-2xl transform group-hover:scale-105 transition-transform">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-[#f0f6fc] tracking-tight">
              <span className="bg-linear-to-r from-[#f0f6fc] via-[#fd7e14] to-[#f0f6fc] bg-clip-text text-transparent animate-gradient">
                rari
              </span>
            </h1>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              ...
              className="group relative w-full sm:w-auto px-8 py-4 bg-linear-to-r from-[#fd7e14] to-[#e8590c] text-gray-900 rounded-lg font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-2xl hover:shadow-[#fd7e14]/50 transform hover:-translate-y-1"
            >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {[
            ...
            >
              <div className={`absolute -inset-0.5 bg-linear-to-r ${feature.gradient} rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              <div className={`relative px-5 py-2.5 bg-linearto-br from-[#161b22] to-[#0d1117] border ${feature.border} rounded-full text-sm font-medium text-gray-200 hover:text-white transition-all duration-300 backdrop-blur-sm`}>
