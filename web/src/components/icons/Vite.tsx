...
export default function Vite(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="color(display-p3 0.5252 0.2300 1.0000)"
      ...
      <g mask="url(#a)">
        <g filter="url(#b)">
          <ellipse
            cx="5.508"
            cy="14.704"
            fill="color(display-p3 0.9275 0.9033 1.0000)"
            rx="5.508"
            ry="14.704"
        ...
        <g filter="url(#d)">
          <ellipse
            cx="5.508"
            cy="30.487"
            fill="color(display-p3 0.4922 0.0767 1.0000)"
            rx="5.508"
            ry="30.487"
        ...
        <g filter="url(#g)">
          <ellipse
            ...
            rx="14.072"
            ry="22.078"
            transform="scale(1 -1)rotate(86.649 51.415 25.983)"
          />
        </g>
        <g filter="url(#h)">
          <ellipse
        ...
        <g filter="url(#k)">
          <ellipse
            cx="41.412"
            cy="6.333"
            fill="color(display-p3 0.2799 0.7480 1.0000)"
            rx="5.971"
            ry="9.665"
