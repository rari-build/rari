                  ...
                  <div className="flex items-center">
                    {isDisabled
                      ...
                      : (
                          <a
                            href={item.href}
                            className={`flex-1 block px-3 py-2.5 rounded-md text-sm font-medium transition-all duration-200 ${isActive
                              ...
                              <div className="flex items-center">
                                {section.href
                                  ? (
                                      <a
                                        href={section.href}
                                        className={`flex-1 block px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ${pathname === section.href
                                        ...
                                        <div className="flex items-center">
                                          {subItem.href
                                            ? (
                                                <a
                                                  href={subItem.href}
                                                  className={`flex-1 flex items-center px-3 py-1.5 rounded-md text-sm transition-all duration-200 ${pathname === subItem.href
                                                    ? 'bg-[#21262d] text-white'
                                                    : 'text-gray-300 hover:bg-[#21262d] hover:text-gray-100'
                                                  }`}
                                                >
                                            ...
                                            {subItem.items!.map((nestedItem, subIdx) => (
                                              <li key={subIdx}>
                                                <a
                                                  ...
                                                  className={`flex items-center px-3 py-1.5 rounded-md text-sm transition-all duration-200 ${pathname === nestedItem.href
                                                    ? 'bg-[#21262d] text-white'
                                                    : 'text-gray-300 hover:bg-[#21262d] hover:text-gray-100'
                                                  }`}
                                                >
            ...
            <ul className="space-y-1">
              <li>
                <a
                  ...
                  className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-gray-100 hover:bg-[#21262d] rounded-md transition-colors duration-200"
                >
