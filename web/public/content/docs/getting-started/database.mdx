...
[Neon](https://get.neon.com/KDQudHN) is our recommended database partner for rari applications. Neon provides Postgres with autoscaling, branching, and scale-to-zero capabilities.
