...
<PageHeader title="Metadata" lastUpdated="January 16, 2026" />
...
<CodeBlock filename="src/app/page.tsx" language="tsx">{`export const metadata = {
  title: 'Home | My App',
...
The `PageProps` type provides type-safe access to route parameters and search params.
...
<CodeBlock language="tsx">{`export const metadata = {
...
<CodeBlock filename="src/app/layout.tsx" language="tsx">{`export const metadata = {
  title: {
    template: '%s | My App',
    default: 'My App',
  },
...
<CodeBlock filename="src/app/about/page.tsx" language="tsx">{`export const metadata = {
...
<CodeBlock filename="src/app/products/[id]/page.tsx" language="tsx">{`import type { PageProps } from 'rari'
...
<CodeBlock filename="src/app/blog/layout.tsx" language="tsx">{`export const metadata = {
  openGraph: {
    type: 'article',
  },
}
...
<CodeBlock filename="src/app/blog/[slug]/page.tsx" language="tsx">{`export async function generateMetadata({ params }) {
  const post = await fetchPost(params.slug)
...
<CodeBlock language="tsx">{`// Good - Dynamic metadata
...
<CodeBlock language="tsx">{`// Good - Concise and descriptive
export const metadata = {
