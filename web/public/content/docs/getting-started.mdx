...
<CodeBlock filename="src/app/about/page.tsx" language="tsx">{`import type { PageProps } from 'rari'
...
<CodeBlock filename="src/app/dashboard/page.tsx" language="tsx">{`import type { PageProps } from 'rari'
