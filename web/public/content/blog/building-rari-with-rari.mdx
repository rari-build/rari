...
<div className="not-prose mt-12 pt-8 border-t border-edge">
  ...
  <div className="flex flex-wrap items-center gap-3">
    <a
      ...
      className="inline-flex items-center px-4 py-2 bg-accent !text-accent-fg text-sm font-medium rounded-md hover:bg-accent-hover transition-colors"
    >
      Get Started
    </a>
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-4 py-2 bg-surface border border-edge !text-fg-muted text-sm font-medium rounded-md hover:border-accent hover:!text-fg transition-colors"
    >
      GitHub
    </a>
    <a
