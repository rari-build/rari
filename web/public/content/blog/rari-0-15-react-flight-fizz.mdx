...
export const description =
  'rari 0.15 is the alignment release: official React Flight for RSC and server actions, Fizz for HTML SSR and streaming, hosted on Rust with embedded V8. Experimental use cache ships as a follow-on.'
