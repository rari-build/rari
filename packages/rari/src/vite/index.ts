...
async function loadRscClientRuntime(): Promise<string> {
  ...
  const possiblePaths = [
    path.join(currentDir, '../runtime/rsc-client-runtime.js'),
    path.join(currentDir, '../../src/runtime/rsc-client-runtime.js'),
    path.join(currentDir, '../src/runtime/rsc-client-runtime.js'),
  ]
  ...
  throw new Error(`Could not find rsc-client-runtime.js. Tried: ${possiblePaths.join(', ')}`)
}
