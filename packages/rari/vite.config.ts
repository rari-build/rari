...
export default defineConfig({
  ...
  pack: {
    entry: {
      ...
      'runtime/action-flight-refresh': 'src/runtime/action-flight-refresh.ts',
      'runtime/merge-flight-refresh': 'src/runtime/merge-flight-refresh.ts',
      ...
      'runtime/action-revalidation-kind': 'src/runtime/action-revalidation-kind.ts',
