...
// oxlint-disable
/**
 * Auto-generated ESM bundle of React react-server-dom-webpack-server (production).
...
import * as __ext_react from 'ext:rari/react/vendor/react-server.js';
...
var require_react_dom_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	"production" !== process.env.NODE_ENV && (function() {
		...
		var React = __ext_react, Internals = {
			d: {
				f: noop,
				r: function() {
...
//#endregion
//#region ../../node_modules/.pnpm/react-server-dom-webpack@19.2.7_react-dom@19.2.7_react@19.2.7__react@19.2.7_webpack@5.107.2/node_modules/react-server-dom-webpack/cjs/react-server-dom-webpack-server.browser.production.js
/**
* @license React
...
* LICENSE file in the root directory of this source tree.
*/
var require_react_server_dom_webpack_server_browser_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	var ReactDOM = require_react_dom();
	var React = __ext_react;
	...
	var DefaultAsyncDispatcher = {
		getCacheForType: function(resourceType) {
			var JSCompiler_inline_result = (JSCompiler_inline_result = currentRequest ? currentRequest : null) ? JSCompiler_inline_result.cache : /* @__PURE__ */ new Map();
	...
	function requireAsyncModule(id) {
		var promise = __rari_rsc_require__(id);
	...
	function preloadModule(metadata) {
		for (var chunks = metadata[1], promises = [], i = 0; i < chunks.length;) {
			...
			void 0 === entry ? (chunkMap.set(chunkId, chunkFilename), chunkFilename = __rari_chunk_load__(chunkId), promises.push(chunkFilename), entry = chunkCache.set.bind(chunkCache, chunkId, null), chunkFilename.then(entry, ignoreReject), chunkCache.set(chunkId, chunkFilename)) : null !== entry && promises.push(entry);
		}
	...
	function requireModule(metadata) {
		var moduleExports = __rari_rsc_require__(metadata[0]);
...
//#endregion
//#region \0virtual:react-server-dom-webpack-server
var import_react_server_dom_webpack_server_browser_production = /* @__PURE__ */ __toESM(require_react_server_dom_webpack_server_browser_production());
globalThis.process = globalThis.process || { env: { NODE_ENV: "production" } };
if (!globalThis.process.env) globalThis.process.env = {};
globalThis.process.env.NODE_ENV = "production";
const { renderToReadableStream, decodeReply, decodeAction, decodeFormState, registerServerReference, registerClientReference, createClientModuleProxy } = import_react_server_dom_webpack_server_browser_production;
var _virtual_react_server_dom_webpack_server_default = import_react_server_dom_webpack_server_browser_production;

//#endregion
export { createClientModuleProxy, decodeAction, decodeFormState, decodeReply, _virtual_react_server_dom_webpack_server_default as default, registerClientReference, registerServerReference, renderToReadableStream };