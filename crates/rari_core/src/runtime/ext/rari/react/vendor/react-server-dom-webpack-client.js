...
// oxlint-disable
/**
 * Auto-generated ESM bundle of React react-server-dom-webpack-client (production).
...
import * as __ext_react_dom from 'ext:rari/react/vendor/react-dom.js';
...
//#endregion
//#region ../../crates/rari/src/runtime/ext/rari/react/vendor/.tmp-react-server-dom-webpack-client.cjs
/**
* @license React
...
*/
var require__tmp_react_server_dom_webpack_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	var ReactDOM = __ext_react_dom;
	...
	function defaultEncodeFormAction(identifierPrefix) {
		...
		function resolveRariFormActionUrl() {
			var rari = (typeof globalThis !== "undefined" ? globalThis : {})["~rari"];
			if (rari && rari.actionPostUrl) return rari.actionPostUrl;
...
//#endregion
//#region \0virtual:react-server-dom-webpack-client
var import__tmp_react_server_dom_webpack_client = /* @__PURE__ */ __toESM(require__tmp_react_server_dom_webpack_client());
globalThis.process = globalThis.process || { env: { NODE_ENV: "production" } };
if (!globalThis.process.env) globalThis.process.env = {};
globalThis.process.env.NODE_ENV = "production";
const { createFromFetch, createFromReadableStream, createServerReference, createTemporaryReferenceSet, encodeReply } = import__tmp_react_server_dom_webpack_client;
var _virtual_react_server_dom_webpack_client_default = import__tmp_react_server_dom_webpack_client;

//#endregion
export { createFromFetch, createFromReadableStream, createServerReference, createTemporaryReferenceSet, _virtual_react_server_dom_webpack_client_default as default, encodeReply };